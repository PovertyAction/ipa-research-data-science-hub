...
![Prioritization criteria](/assets/images/prioritization-matrix.png){width=70%}
...
::: {.callout-tip}
## Box 3. Good Practices for Designing Variations
...
::: {.callout-tip}
## Box 4. How to Check if Your A/B Testing System is Ready to Go Live
...
[^9]: Review power calculations for the experiment. You can use [J-PAL's Quick Guide to Power Calculations](https://www.povertyactionlab.org/resource/quick-guide-power-calculations).

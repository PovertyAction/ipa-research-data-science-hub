...
When working in a clear Stata session, you can use `set obs n` where n is an integer, to create that many observations in the dataset. From there, you can `generate` variables set to whatever you are interested in.

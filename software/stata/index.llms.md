...
>
> IPA staff can download and install the relevant version (`.exe` for Windows, `.dmg` for MacOS, or `.tar.gz` for Linux) from IPA Box [installation documentation](https://ipastorage.app.box.com/folder/129276324764?v=install-stata).
>
...
![](../../assets/images/stata-interface.png)
...
![](../../assets/images/stata-point-click.png)
...
![](../../assets/images/stata-command-line.gif)
...
![](../../assets/images/stata-working-directory.jpg)
...
![](../../assets/images/stata-relative-path.jpg)

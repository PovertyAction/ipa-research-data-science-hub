...
The shell typically uses `$`, `PS>`, or `>` as the prompt, but may use a different symbol depending on your shell and configuration.
...
has just completed data collection for a
...
As a bonus,
once she has built her validation pipeline,

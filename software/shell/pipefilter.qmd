...
abstract: >-
  Discover the power of combining shell commands using pipes and filters. Learn
  to chain simple commands together to perform complex data processing tasks
  efficiently. Use the Unix philosophy of building powerful workflows from
  simple tools.
authors-ipa:
...
validation. This is exactly what Amara needs for their survey quality checks!

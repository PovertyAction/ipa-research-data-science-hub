...
For our examples,
we will use Amara's survey data files to search for specific patterns. For this set of examples,
we're going to be working in the survey-data subdirectory:

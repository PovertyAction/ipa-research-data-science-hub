...
Since `report` is a relative path (i.e., it doesn't have a leading slash,
like `/what/ever/report`), the new directory is created in the current working directory:

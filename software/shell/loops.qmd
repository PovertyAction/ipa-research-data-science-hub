...
title: "Loops"
abstract: >-
  Automate repetitive tasks using shell loops. Learn to write for loops that
  process multiple files efficiently, applying the same operations across
  datasets. Learn the syntax and patterns for effective shell scripting
  automation.
authors-ipa:

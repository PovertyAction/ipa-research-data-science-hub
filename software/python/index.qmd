...
To follow along, you will need to work in a [jupyter notebook](https://jupyter.org/try-jupyter/notebooks/?path=notebooks/Intro.ipynb) with the right libraries installed in your [environment](../guides/venv.qmd). This example demonstrates what is possible with Python for data analysis. The [Processing Data in Python](data-processing-python.qmd) guide revisits this example in more detail.
:::

...
1.  [GitHub Desktop](https://docs.github.com/en/desktop) (Recommended)- GUI for working with Git repositories.
2.  [GitHub CLI](https://docs.github.com/en/github-cli) - Command-line interface for working with Git repositories. For advanced usage.
...
See [instructions](https://docs.github.com/en/desktop/overview/getting-started-with-github-desktop) for getting started with GitHub Desktop.
...
![](../../assets/images/git/github-desktop-auth.gif)

GitHub Desktop Authentication

### GitHub CLI

See the [GitHub CLI Manual](https://cli.github.com/manual/) for more information on how to authenticate with GitHub CLI.
...
2.  **Issues**: A place to discuss and track tasks, bugs, and enhancements for a project.
3.  **Pull Requests**: A way to propose changes to a repository and discuss them with others.
...
- [GitHub Skills](https://skills.github.com/) provides a lot of relevant resources for learning how to use GitHub. Some good starting points include:

...
[uv](https://docs.astral.sh/uv) is a fast Python package installer and resolver written in Rust. It serves as a drop-in replacement for pip and pip-tools, while also providing unified project management capabilities.
...
4.  **Select Kernel**: In JupyterLab, choose “Python (myproject)” from the kernel menu.
...
- [Official uv Documentation](https://docs.astral.sh/uv/) - Comprehensive reference
- [uv GitHub Repository](https://github.com/astral-sh/uv) - Source code and issue tracker
- [Python Packaging User Guide](https://packaging.python.org/) - Python packaging standards
- [pyproject.toml Specification](https://packaging.python.org/en/latest/specifications/pyproject-toml/) - Project configuration format

For general Python setup and data science workflows, see:

- [Getting Started with Python](../../software/python/index.llms.md) - Broader Python introduction
- [Virtual Environments Overview](../../software/virtualenv/index.llms.md) - Comparison of virtual environment tools

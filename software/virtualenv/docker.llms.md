...
[Docker](https://www.docker.com/) is a platform that uses containerization technology to package applications and their dependencies into standardized units called containers. Containers include everything needed to run an application: code, runtime, system tools, libraries, and settings.
...
For other Linux distributions, see [Docker’s official installation guide](https://docs.docker.com/engine/install/).
...
- [Jupyter Docker Stacks](https://jupyter-docker-stacks.readthedocs.io/) - Ready-to-run Jupyter environments
- [The Turing Way: Reproducible Environments](https://the-turing-way.netlify.app/reproducible-research/renv.html) - Research reproducibility guide
...
- [Virtual Environments Overview](../../software/virtualenv/index.llms.md) - Comparison of environment management tools
- [Python with uv](../../software/virtualenv/python-uv.llms.md) - Python-specific virtual environments

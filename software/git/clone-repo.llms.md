...
- **Configuration files**: Pre-configured `.gitignore` and other project settings
...
> **TIP:**
>
> For more information about cloning repositories, see the [GitHub cloning guide](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository).
>
> To learn more about template repositories, see [GitHub’s template repository documentation](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-template-repository).
...
>
> 1.  Use the “Use this template” button on GitHub to create your own repository based on the template
> 2.  Clone your copy of the template, which will have your username or organization name
>
...
>
> - **Continue the Git tutorial series**: Work through [Configure Git](../../software/git/configuration.llms.md), [Track Changes](../../software/git/track-changes.llms.md), and other tutorials using this cloned repository
> - **Explore the template**: Open the files in the template to see IPA’s recommended structure and documentation practices
> - **Learn about Stata workflows**: See the [Stata documentation](../../software/stata/index.llms.md) to learn how to use Stata for research projects
> - **Start a real project**: When ready, see the [ipa-stata-template on GitHub](https://github.com/PovertyAction/ipa-stata-template), click “Use this template” to create your own repository, then clone it to begin your work
...
- The `ipa-stata-template` includes folder organization, Stata do-files, documentation templates, and configuration files
- For real projects, use “Use this template” to create your own repository first, then clone it

...
![The Conflicting Changes](figures/conflict.svg)
...
![Merge conflict in earth.txt](figures/vscode-merge-conflict.png)
...
![Resolving the merge conflict with the merge editor](figures/vscode-merge-editor.png)
...
![The bottom pane contains the resolved earth.txt contents](figures/vscode-merge-resolved.png)
...
[◀ Previous: Pull Requests](pull-request.qmd) | [Next: Practice ▶](practice.qmd)
:::

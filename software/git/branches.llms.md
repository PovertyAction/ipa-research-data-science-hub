...
Learn how to use Git branches to work on separate tasks in parallel, experiment with different solutions, and safely develop features without affecting the main codebase.
...
Thus far we’ve always been working in a straight timeline. However, there are times when we might want to keep our main work safe from experimental changes we are working on. To do this we can use branches to work on separate tasks in parallel without changing our current branch, `main`.
...
Now let’s write what happens on Asgard.
...
Let’s check our work again before we switch back to the main branch.
...
![](../../assets/images/git/github-branch-pushed.png)

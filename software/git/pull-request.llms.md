...
Learn how to create and manage pull requests on GitHub to propose changes, collaborate with others, and merge contributions into the main codebase safely.
...
![](../../assets/images/git/github-open-pr.png)
...
![](../../assets/images/git/github-pr-opened.png)
...
``` output
2f2d364 (HEAD -> main, origin/main, origin/HEAD) Record formation of Gran Colombia
...
``` output
976b48e (HEAD -> main, origin/main, origin/HEAD) Merge pull request #1 from simon-bolivar-historian/heimdall-aware
daf95c3 (origin/heimdall-aware, heimdall-aware) Create asgard.txt detailing Heimdall's awareness of invasion
2f2d364 Record formation of Gran Colombia
ee67c8b Implement counterattack strategy
9b26458 Start story for New Asgard in earth.txt
f537d84 Initial commit
```

...
2. **ipa-stata-template**: A repository you cloned in the [Clone a GitHub Repository](clone-repo.qmd) tutorial for research workflows
...
If you don't immediately see your `multiverse` repo, you can search for it by typing "multiverse" in the search box. When you see your `multiverse` repo (it

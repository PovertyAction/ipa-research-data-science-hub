...
keywords: ["Git", "GitHub", "Repository", "Clone", "Template Repository", "VS Code", "Tutorial"]
license:
  text: "CC BY-SA"
...
**Cloning** creates a local copy of a remote repository on your computer. This is
different from creating a new repository, which you will learn in the next tutorial.

When you clone a repository, you download all its files, folders, and Git history
to your local machine. This allows you to work with the code, make changes, and
sync those changes back to the remote repository on GitHub.
...
Template repositories are special GitHub repositories designed to provide standardized
starting points for new projects. Instead of starting with an empty repository,
templates include pre-configured files, folder structures, and documentation that follow best practices.
...
If you navigate to this address in your web browser, you see the repository's main page.
...
In a real workflow, you would typically use the template to create your own repository
first, then clone that.
...
Make sure you have a new VS Code window open. If you already have a repository or
folder open in VS Code, go to the "File" menu and click "New window".
...
- **Continue the Git tutorial series**: Work through [Configure Git](configuration.qmd), [Track Changes](track-changes.qmd), and other tutorials using this cloned repository
- **Explore the template**: Open the files in the template to see IPA's recommended structure and documentation practices
- **Learn about Stata workflows**: See the [Stata documentation](../stata/index.qmd) to learn how to use Stata for research projects

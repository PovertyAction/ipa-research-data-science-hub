...
Learn how to synchronize your local Git repository with a remote repository on GitHub by pushing and pulling changes, enabling collaboration and backup.
...
> **NOTE:**
>
> Note that our local repository still contains our earlier work on `campaigns.txt`, but the remote repository on GitHub only contains the README file.
>
> Because we created our repo on GitHub first and then cloned it to our local computer, the two repositories are already connected. If we had instead created the local repo first, then the remote repo on GitHub, we would need to manually connect the two repos, with a command like:
>
> ``` bash
> git remote add origin git@github.com:simon-bolivar-historian/multiverse.git
> ```
>
...
>
> ``` output
> origin  https://github.com/simon-bolivar-historian/multiverse.git (fetch)
> origin  https://github.com/simon-bolivar-historian/multiverse.git (push)
> ```
...
To https://github.com/simon-bolivar-historian/multiverse.git
...
``` output
From https://github.com/simon-bolivar-historian/multiverse
...
![](../../assets/images/git/github-pushed-changes.png)

Changes have been pushed

You should now see the `campaigns.txt` file. **Click on the file**, and you can see the contents of the file are the same as in VS Code.

![](../../assets/images/git/github-earth.png)

View campaigns.txt

Now **click on the “History” link**. You should see each commit made to the file, even though we only pushed once.

![](../../assets/images/git/github-earth-history.png)

View campaigns.txt commits

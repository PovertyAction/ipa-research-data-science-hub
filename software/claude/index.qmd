...
Claude is an AI assistant from Anthropic. This page introduces what it does and the difference between the chat and the file-aware Claude Code. It also covers what to consider when using it with research data, and where to go to set it up.
:::

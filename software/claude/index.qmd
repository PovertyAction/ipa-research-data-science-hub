...
abstract: |
  An orientation to Claude, the AI assistant from Anthropic, and Claude Code, the version that works with the files on your computer. This page explains what these tools do, what to keep in mind when using them with research data, and how to choose a setup path.
keywords:
  - "AI"
  - "Claude"
  - "Claude Code"
...
Claude is an AI assistant from Anthropic. This page introduces what it does and the difference between the chat and the file-aware Claude Code. It also covers what to keep in mind when using it with research data, and where to go to set it up.[^source]
:::
...
- **Cowork**: a mode that completes self-contained, multi-step tasks on your behalf and delivers finished work. See [Anthropic's Cowork page](https://claude.com/product/cowork).
- **Claude Code**: an assistant that works directly with the files on your computer, where you review each change as it happens.

These guides focus on **Claude Code**.
...
Anthropic. "Cowork." [https://claude.com/product/cowork](https://claude.com/product/cowork).

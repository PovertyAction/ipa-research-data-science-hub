...
This guide installs Claude Code and gets you to your first session. Pick the path that matches how you work: the terminal and VS Code, or the desktop app. Both run the same Claude Code and are covered by the same plan.
:::

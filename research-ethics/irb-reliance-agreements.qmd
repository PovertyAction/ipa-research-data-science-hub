...
Ask the other IRB if they are willing to rely on IPA IRB's review. Then, send an email to [humansubjects@poverty-action.org](mailto:humansubjects@poverty-action.org) with:

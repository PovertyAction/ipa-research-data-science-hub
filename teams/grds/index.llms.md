...
The Global Research and Data Science (GRDS) Unit at IPA builds tools and data systems that enable high-quality data collection and application of data science methods to improve research efficiency and replicability grounded in ethical principles.
...
The Global Research and Data Science (GRDS) Unit at Innovations for Poverty Action (IPA) develops data systems and tools that support evidence generation and use. GRDS works across IPA and with external partners to make these systems efficient, ethical, and scalable, so evidence better informs programs and policies.

------------------------------------------------------------------------

GRDS operates across five service areas, described below.

...
abstract: >-
  The Global Research and Data Science (GRDS) Unit at IPA builds tools and data
...
Action (IPA) develops data systems and tools that support evidence generation
and use. GRDS works across IPA and with external partners to make these systems
efficient, ethical, and scalable, so evidence better informs programs and
policies.

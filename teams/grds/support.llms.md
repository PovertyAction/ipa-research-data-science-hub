...
- [Dennis Kembero](https://poverty-action.org/people/dennis-ongwae)
...
This guide walks through the process of requesting and managing GRDS support. For a description of what GRDS offers — the five service areas and the three engagement types — see [GRDS Services Reference](../../teams/grds/services.llms.md).
...
``` mermaid
flowchart TD
    A["Support request<br/>researchsupport@"] ---> B["Ticket logged and classified<br/>in Freshservice"]
...
GRDS logs every support request that arrives at `researchsupport@` as a ticket in Freshservice, the system of record for intake. Classification determines which service area the request belongs to and which staff member picks it up.
...
For background on Agile, Waterfall, and related methods, see Atlassian’s [introduction to project management approaches](https://www.atlassian.com/agile/project-management/project-management-intro) and Asana’s [comparison of Waterfall, Agile, Kanban, and Scrum](https://asana.com/resources/waterfall-agile-kanban-scrum).

For the engagement types these paths map onto, see [GRDS Services Reference](../../teams/grds/services.llms.md).
...
2.  **Submit the full request**
    ...
    | **Support type requested** | The nature of the support needed (see the service areas in [GRDS Services Reference](../../teams/grds/services.llms.md)) |

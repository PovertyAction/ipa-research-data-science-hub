...
abstract: "Learn the fundamentals of web scraping using gazpacho, a lightweight Python library that simplifies extracting data from websites. Apply essential techniques for collecting data from web pages for research and analysis."
authors:
...
This content is based on the [gazpacho
library](https://github.com/maxhumber/gazpacho) by Max Humber (MIT License) and
incorporates concepts from
[calmcode.io](https://calmcode.io/course/gazpacho/introduction) tutorials, which
are licensed under CC BY 4.0. The gazpacho library is used under the MIT
License.
:::
...
parsing HTML content. It's a powerful technique for collecting structured data
from web pages that don't provide APIs or downloadable datasets.
...
Gazpacho is a lightweight Python library that simplifies web scraping by
providing an intuitive interface for HTML parsing. It's designed to be easier
than traditional tools like requests + BeautifulSoup while maintaining essential
functionality.
...
This tutorial series will guide you through web scraping fundamentals using
gazpacho:
...
- [HTML and CSS
  fundamentals](https://developer.mozilla.org/en-US/docs/Learn/HTML)

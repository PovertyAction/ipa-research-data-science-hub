...
abstract: >-
  Learn the fundamentals of web scraping using gazpacho, a lightweight Python
  library that simplifies extracting data from websites. Apply essential
  techniques for collecting data from web pages for research and analysis.
authors:

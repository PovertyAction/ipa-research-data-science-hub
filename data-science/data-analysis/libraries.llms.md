...
Explain what software libraries are and why programmers create and use them. Write programs that import and use modules from Python’s standard library. Find and read documentation for the standard library interactively (in the interpreter) and online.
...
> > ```
> >
> > Note that this function returns a list of values. Later, we will learn about [lists](../../data-science/data-analysis/lists.llms.md).
> >

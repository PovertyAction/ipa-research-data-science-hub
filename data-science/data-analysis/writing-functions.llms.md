...
Explain and identify the difference between function definition and function call. Write a function that takes a small, fixed number of arguments and produces a single result.
...
- Remember: [every function returns something](../../data-science/data-analysis/built-in.llms.md).
...
def another_function
  ...
  print("They are usually not too hard to fix.")
```
...
> ```
>
> A function call always needs parenthesis, otherwise you get memory address of the function object. If we wanted to call the function named report, and give it the value 22.5 to report on, we could have our function call as follows
>
> ``` python
> print("calling")
> report(22.5)
...
## Exercise: Encapsulation of an If/Print Block

The code below will run on a label-printer for chicken eggs. A digital scale will report a chicken egg mass (grams) to the computer and then the computer will print a label.

...
- For IPA projects, we use Ruff for both linting and formatting. See the [Python guide](../../software/python/index.qmd#coding-conventions) for setup instructions and configuration details. You can run `ruff check` to find issues and `ruff format` to automatically format your code.

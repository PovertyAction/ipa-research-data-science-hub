...
- We will look at error messages in detail [later](scope.qmd#reading-error-messages).
...
number. In the [next lesson on types and type conversion](types-conversion.qmd)

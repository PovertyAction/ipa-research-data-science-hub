...
- Use `[]` on its own to represent a list that doesn’t contain any values.
  - “The zero of lists.”
- Helpful as a starting point for collecting values (which we will see in the [loops](../../data-science/data-analysis/for-loops.llms.md) page).
...
- Python reports an `IndexError` if we attempt to access a value that doesn’t exist.
  - This is a kind of [runtime error](../../data-science/data-analysis/built-in.llms.md).
...
> > **TIP:**
> >
> > The list `values[start:stop]` has up to `stop - start` elements. For example, `values[1:4]` has the 3 elements `values[1]`, `values[2]`, and `values[3]`. Why ‘up to’? As we saw in the [variables](../../data-science/data-analysis/variables.llms.md) page, if `stop` is greater than the total length of the list `values`, we will still get a list back but it will be shorter than expected.

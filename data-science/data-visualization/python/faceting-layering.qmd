...
**Small multiples** (also called faceting or trellis plots) show the same visualization
repeated across different subsets of data. Edward Tufte, the data visualization expert,
called them "the best design solution" for comparing categories.
...
In the next lesson, we'll explore statistical transformations - how to add regression lines,
confidence intervals, aggregations, and other statistical summaries directly to our visualizations.

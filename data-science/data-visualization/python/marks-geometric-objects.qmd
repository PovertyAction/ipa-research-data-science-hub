...
are the visual elements that represent data points. Each mark type is designed to
show different aspects of data:
...
The combination of bars (showing the average) and dots (showing individual values)
gives viewers both the summary and the underlying data distribution.

...
aliases:
  - /data-science/data-visualization/marks-geometric-objects.html
abstract: |
  Learn about different types of marks (geometric objects) in seaborn.objects.
  Create scatter plots, line plots, bar plots, and more. Choose appropriate marks
  for different data types and research questions.
authors-ipa:

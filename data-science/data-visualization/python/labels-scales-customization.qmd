...
A visualization without proper labels is like a research paper without citations - the
data might be there, but the message is unclear. Consider your audience:
...
❌ Bad: `x="Income"`
✅ Good: `x="Monthly Income (KSh)"`

❌ Bad: `y="Distance"`
✅ Good: `y="Distance to Health Facility (km)"`

### 2. Use Plain Language

❌ Bad: `title="DV regressed on IV controlling for confounds"`
✅ Good: `title="Relationship Between Education and Income, Controlling for Age"`

### 3. Provide Context

❌ Bad: `title="Survey Results"`
✅ Good: `title="Household Food Security Survey Results: Kisumu County, 2023"`

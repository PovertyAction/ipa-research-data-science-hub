...
abstract: "Why sound data does not automatically change decisions, and what closes that gap: mapping who needs the evidence, tailoring the message to their needs, and communicating early rather than only at the end."
...
Abdul Latif Jameel Poverty Action Lab (J-PAL). "Evidence to Policy." [https://www.povertyactionlab.org/evidence-to-policy](https://www.povertyactionlab.org/evidence-to-policy).

...
abstract: "How to develop a robust Theory of Change, linking program activities to outcomes through evidence-based pathways."
...
- A **Theory of Change** maps how program activities lead to intended outcomes
  through clear, logical pathways
- Strong ToCs must be **active** (specific actions), **clear** (distinct
  components), **logical** (causal relationships), and **detailed** (sufficient
  for M&E)
- Every ToC pathway relies on **explicit assumptions** and **risks** that need
...
out the logical sequence from activities to outputs to outcomes to impact,
making explicit the assumptions underlying each link in the causal chain.
...
The visual representation helps stakeholders quickly grasp the overall logic,
while the narrative provides essential detail about mechanisms and assumptions.
:::
...
**Communication**: Provides a clear, concise way to explain your program to
stakeholders

**Alignment**: Creates shared understanding among team members about goals and
strategies
...
A comprehensive ToC consists of five key components that form a logical chain
...
**Example**: "Deliver 10 business skills training sessions to caregivers" NOT
"Support caregivers"
:::
...
**Measurement**: During or immediately after implementation **Attribution**:
Directly attributable to program activities
:::
...
Every arrow in a Theory of Change represents assumptions about how change
happens. Making these explicit is crucial for learning and adaptation.
...
Different methods help test assumptions and understand risks at various stages
of implementation.
...
IPA's **Right-Fit Evidence (RFE)** team has developed practical tools and
frameworks for creating and using Theories of Change effectively.
...
**Problem**: Using general terms like "improve wellbeing" or "strengthen
capacity" **Solution**: Be specific about what will change and how you'll
measure it
:::
...
**Problem**: Jumping from training to long-term impact without intermediate
steps **Solution**: Think through each necessary change in the causal chain
:::

::: {.callout-warning collapse="true"}
## Pitfall 3: Overly Complex

**Problem**: Including every possible pathway and outcome **Solution**: Focus on
the main causal pathways; document others separately
:::

::: {.callout-warning collapse="true"}
## Pitfall 4: Static Document

**Problem**: Creating a ToC once and never updating it **Solution**: Review and
revise based on learning; document changes
:::

## Additional Resources

- [IPA's Right-Fit Evidence
  Resources](https://www.poverty-action.org/right-fit-evidence)
- [Theory of Change Guidance -
  UNICEF](https://www.unicef-irc.org/publications/pdf/Brief%202%20Theory%20of%20Change_ENG.pdf)
- [DIY Toolkit: Theory of
  Change](https://diy-toolkit.org/tools/theory-of-change/)

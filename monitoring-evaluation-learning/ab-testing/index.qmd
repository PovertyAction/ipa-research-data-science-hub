...
::: {.callout-note}
This guide is a living product that is written and maintained publicly. We welcome feedback and corrections to improve this guide. If you would like to contribute, please reach out to [researchsupport@poverty-action.org](mailto:researchsupport@poverty-action.org) or see the [Contributing](/CONTRIBUTING.qmd) page.
:::

...
![](../../assets/images/stage-based-learning.png)

Stage-Based Learning (© IPA)
...
Learning needs at the Refine, Adapt, and Scale Stages {.caption-top .table}

### When A/B Testing Supports Learning Goals

**In the Refine stage**, A/B testing can support learning needs by enabling organizations to systematically test variations[^2] to the program that could address these questions.

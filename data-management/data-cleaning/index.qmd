...
This guide outlines best practices of data cleaning, focusing on how to manipulating raw data using Stata
:::

:::{.callout-tip appearance="simple"}
## Key Takeaways
* Raw data cannot be used for analysis. Thus, we need to follow principles of data cleaning during our project's lifecycle.
* IPA’s Data Management System (DMS) supports data quality monitoring, duplicate management, and corrections.
:::

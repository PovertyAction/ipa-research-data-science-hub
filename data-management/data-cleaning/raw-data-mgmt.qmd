...
## Key Takeaways
* Raw data management requires careful consideration of data structure (wide vs. long format), proper handling of unique identifiers, and systematic approaches to data modifications to ensure reproducibility and data integrity.
* Implementing proper PII handling procedures, including early de-identification of data, encryption, and separate workflows for identified vs. de-identified data analysis, is crucial for ensuring data security and compliance with research protocols.
:::
...
foreach file in `files' {
	...
	* Edit filename 
	...
	extension (in this cas .xlsx). So, I remove these and 

...
---
:::{.page-subtitle}
This resource guides you through securing your data collected via Twilio. You'll learn to create and configure an encryption widget in Twilio, understand and use Python encryption code before publishing to Google Sheets, and decrypt data using Python. By the end, you'll be equipped to implement robust encryption measures, ensuring your data's confidentiality and integrity.
:::
...
![Encrypt Service](/assets/images/twilio-encrypt-1.png){fig-cap="Encrypt Service" width=100%}
...
![Encrypt configuration snapshot](/assets/images/twilio-encrypt-2.png){fig-cap="Encrypt configuration snapshot" width=100%}

4. Modify the secret_key and store it securely on your computer. Modify line 50 as it is shown in the next image.

![Change encryption key](/assets/images/twilio-encrypt-3.png){fig-cap="Change encryption key" width=100%}
...
![Encryption Widget Configuration](/assets/images/twilio-encrypt-4.png){fig-cap="Encryption Widget Configuration" width=100%}
...
![Encryption Widget Configuration Example](/assets/images/twilio-encrypt-5.png){fig-cap="Example of the parameter configuration" width=70%}
...
![Example of the configuration of the publish function](/assets/images/twilio-encrypt-6.png){fig-cap="Example of the configuration of the publish function" width=100%}

...
![Twilio Logo (® Twilio)](/assets/images/twilio-logo.png){width=100%}
...
![Twilio setup and login](/assets/images/twilio-setup-1.gif){fig-cap="Twilio setup and login" width=90% style="display: block; margin: 0 auto;"}
...
![Buying a phone number in the Twilio Console](/assets/images/twilio-setup-2.gif){fig-cap="Buying a phone number in the Twilio Console" width=90%}

5. Upgrade the account to access WhatsApp functionalities.

![Upgrading the Twilio Console](/assets/images/twilio-setup-3.gif){fig-cap="Upgrading the Twilio Console" width=90%}
...
![Create a new WhastApp sender](/assets/images/twilio-setup-4.gif){fig-cap="Create a new WhastApp sender" width=90%}
...
![Create a new WhastApp profile](/assets/images/twilio-setup-5.gif){fig-cap="Create a new WhastApp profile" width=90%}

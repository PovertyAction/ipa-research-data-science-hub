...
- Open an issue on GitHub to suggest changes or report problems,
    [Report an
...
- Email the[IPA Global Research and Data Science
    ...
    GRDS can help you convert your content into the appropriate format
    and add it to the Hub.
- If you are an IPA staff member, you can also contact the GRDS team
    on the `IPA - Colab - Research` group on Microsoft Teams by tagging
...
- Include blank lines before and after headings, lists, and code
    blocks

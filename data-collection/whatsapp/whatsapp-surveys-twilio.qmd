...
![Twilio Logo (® Twilio)](/assets/images/twilio/twilio-logo.png){width=100%}
...
![Create a new WhastApp sender](/assets/images/twilio/twilio-setup-4.gif){fig-cap="Create a new WhastApp sender" width=100%}
...
![Create a new WhastApp profile](/assets/images/twilio/twilio-setup-5.gif){fig-cap="Create a new WhastApp profile" width=100%}

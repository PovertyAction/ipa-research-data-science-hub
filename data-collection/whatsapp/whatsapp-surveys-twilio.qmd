...
![Create a new WhastApp sender](/assets/images/twilio-setup-4.gif){fig-cap="Create a new WhastApp sender" width=100%}
...
![Create a new WhastApp profile](/assets/images/twilio-setup-5.gif){fig-cap="Create a new WhastApp profile" width=100%}

...
![Create a new content template](/assets/images/twilio/twilio-design-17.png){fig-cap="Create a new content template" width=100%}
...
![New content template](/assets/images/twilio/twilio-design-18.gif){fig-cap="Create a new content template" width=110%}
...
![Create a new Twilio flow](/assets/images/twilio/twilio-design-5.gif){fig-cap="Create a new Twilio flow" width=100%}
...
![Send & Wait Widget Example](/assets/images/twilio/twilio-design-9.png){fig-cap="Send & Wait Widget Example" width=80%}
...
![Create a New Service](/assets/images/twilio/twilio-design-15.png){fig-cap="Create a New Service" width=100%}

...
| Criterion | In-Person | [Phone Surveys](../data-collection/phone-surveys.llms.md) | [WhatsApp](../data-collection/whatsapp/index.llms.md) | [Admin Data](../data-collection/admin-data.llms.md) |
|----|----|----|----|----|
...
In-person surveys often achieve optimal results when integrated with complementary data collection approaches. Baseline studies using in-person methods can be efficiently followed by [phone surveys](../data-collection/phone-surveys.llms.md) for tracking purposes, reducing costs while maintaining contact with study populations. Combining quantitative survey data with [qualitative methods](../data-collection/qualitative-methods/index.llms.md), such as [focus groups](../data-collection/qualitative-methods/focus-groups.llms.md) or [in-depth interviews](../data-collection/qualitative-methods/interviews.llms.md), provides richer contextual understanding.

Primary data collection gains significant value when linked with [administrative data](../data-collection/admin-data.llms.md) sources for comprehensive outcome measurement. [WhatsApp surveys](../data-collection/whatsapp/index.llms.md) serve well for interim check-ins, appointment scheduling, or simple follow-up questions that maintain participant engagement between major data collection rounds.
...
Implementation must align with IPA’s comprehensive [data quality framework](../data-quality/index.llms.md), incorporating required protocols for [survey planning](../data-quality/survey-plan.llms.md) and [IRB compliance](../research-ethics/irb-lifecycle.llms.md). Quality systems should implement [data integrity](../data-quality/data-integrity.llms.md) and [data anonymization](../data-quality/data-anonymization.llms.md) measures throughout the survey lifecycle, while field protocols use [bench testing](../data-quality/bench-testing.llms.md) and [accompaniment procedures](../data-quality/accompany-surveyors.llms.md) to maintain standards.

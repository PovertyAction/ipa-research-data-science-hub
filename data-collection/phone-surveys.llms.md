...
\* May require additional considerations for respondent fatigue and survey burden {.table}
...
| [WhatsApp Start Guide](../data-collection/whatsapp/index.llms.md) | Pre-contact message implementation tips |
...
Phone survey implementation must align with IPA’s comprehensive [data quality framework](../data-quality/index.llms.md), incorporating required protocols for [survey planning](../data-quality/survey-plan.llms.md) and [IRB compliance](../research-ethics/irb-lifecycle.llms.md). Quality systems should implement [data integrity](../data-quality/data-integrity.llms.md) and [data anonymization](../data-quality/data-anonymization.llms.md) measures throughout the survey lifecycle, while field protocols use [high-frequency checks](../data-quality/high-frequency-checks.llms.md) and [back-check procedures](../data-quality/backchecks.llms.md) to maintain standards.

For comprehensive guidance on survey implementation, see the [in-person surveys guide](../data-collection/in-person-surveys.llms.md) for comparison of methodological approaches and the [data quality section](../data-quality/index.llms.md) for detailed quality control protocols.

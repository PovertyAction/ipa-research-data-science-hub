...
![](../../assets/images/Ecuador_Training_2022.jpeg)

Field Staff Training in Guayaquil, Ecuador (© IPA, 2022)
...
1.  **Orientation & roles:**Introduce the project, roles, reporting lines, and how to raise issues.
2.  **IRB, ethics, and consent**: Human subjects training; consent scripts; vulnerable populations; privacy.
3.  **Safety & security**: Route planning, check-in rules, emergency contacts, incident reporting.
4.  **Instrument walkthrough (question-by-question)**: Explain logic, skips, constraints, and common pitfalls.
5.  **Mock interviews & role-plays**: Daily practice; model tough scenarios; peer and trainer feedback.
6.  **Device & software**: Tablets/phones, SurveyCTO/ODK apps, syncing, offline modes, backups.
7.  **Quizzes & certification**: Short daily checks plus a final exam to inform hiring/assignments.
8.  **Pilot / practice days**: Supervised field try-outs; debrief to refine the instrument and manual.

...
This guide walks research teams through the complete process of digitizing paper survey data, from deciding who enters the data to verifying accuracy through double entry, reconciliation, and auditing.
:::
...
:::{.callout-note}
Once reconciliation is complete, see [Data Integrity](../../data-quality/data-integrity.qmd) for guidance on backup procedures and secure file storage.
:::
...
: Recommended surveys to audit by survey length (IPA 2011) {#tbl-audit-sample} {.striped}

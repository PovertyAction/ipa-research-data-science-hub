...
> **WARNING:**
>
> This guide covers survey tracking fundamentals applicable to all studies, whether single-round or multi-round. For individual-level contact management and interview attempt documentation, see [Respondent Tracking](../../../data-collection/fieldwork-management/tracking/respondent-tracking.llms.md).
...
>
> - **Real-time data platforms:** Configure shared platforms, e.g., Google Sheets, for immediate team access to completion status ([SurveyCTO tips for dynamic dashboards](https://www.surveycto.com/analysis-reporting/dynamic-dashboards-in-google-sheets/))
> - **Scripted summaries:** Prepare scripts for high-frequency checks, e.g., Stata, Python, R ([IPA High Frequency Checks](../../../data-quality/high-frequency-checks.llms.md), [IPA Data Management System](../../../data-quality/data-management-system.llms.md))
> - **Interactive dashboards:** Set up reporting tools, e.g., PowerBI, for visual summaries

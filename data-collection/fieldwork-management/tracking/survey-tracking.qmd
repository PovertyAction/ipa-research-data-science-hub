...
This guide covers survey tracking fundamentals applicable to all studies, whether single-round or multi-round. For individual-level contact management and interview attempt documentation, see [Respondent Tracking](https://data.poverty-action.org/data-collection/fieldwork-management/tracking/respondent-tracking.html).
...
* **Scripted summaries:** Prepare scripts for high-frequency checks, e.g., Stata, Python, R ([IPA High Frequency Checks](https://data.poverty-action.org/data-quality/high-frequency-checks.html), [IPA Data Management System](https://data.poverty-action.org/data-quality/data-management-system.html))

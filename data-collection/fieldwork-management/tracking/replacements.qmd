...
1. **Exhaust all tracking strategies** before considering cases as closed. See *Longitudinal Tracking Strategies* in the [Survey and Responding Tracking](https://data.poverty-action.org/data-collection/fieldwork-management/tracking/survey-respondent-tracking.html) section.
2. **Budget for tracking efforts**: Allocate 15-25% of field budget specifically for difficult cases
3. **Use specialized mop-up teams**: Deploy experienced trackers for hard-to-find respondents. See [Mop-Up Operations](https://data.poverty-action.org/data-collection/fieldwork-management/tracking/mop-up.html) section.

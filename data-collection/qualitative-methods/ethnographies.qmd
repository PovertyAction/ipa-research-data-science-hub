...
In this article, the IPA Colombia team provides practical guidance on how to plan and implement rapid ethnographic assessments (REA), a technique to ____
:::

:::{.callout-tip appearance="simple"}
## Key Takeaways (validate with David/Qual Team)
* Rapid Ethnographic Assessments (REAs) allow researchers to quickly gather insights on a specific community, issue, or environment.
* REAs prioritize flexibility, triangulation (multiple data sources), and collaboration with local stakeholders to ensure findings are both accurate and relevant
:::

## What is a Rapid Ethnographic Assessment (REA)?

Rapid Ethnographic Assessments (REA) are a qualitative research method that allow nimble collection of information for decision-making. This methodology is characterized by several key features[^1]:
...
## **Public Health (INCLUDE CONTEXT IMAGE)** 
...
::: {.callout-tip collapse="true"}
## **Migration (INCLUDE CONTEXT IMAGE)** 
...
::: {.callout-tip collapse="true"}
## **Emergency Settings (INCLUDE CONTEXT IMAGE)** 
...
- **Data collection technique(s):** Identify data collection techniques that will be prioritized Here, consider the information you want to collect and consult the practical guidelines for focus groups, interviews, and observations, as these are the most common collection techniques in REA. However, depending on the research needs and the research team's experience, other collection techniques such as ethnographic mapping or short surveys can be implemented (For detailed data collection techniques used in rapid ethnographies, see **Annex 1**). 
:::
...
: Table 1. Skills of field staff conducting a REA {.striped}
...
: Table 2. Challenges (and solutions) for REA check-ins {.striped}
...
::: {.callout-tip}
**Use of photographic material (CAN WE INCLUDE HERE AN ACTUAL PHOTO AS REFERENCE?):**
...
: Table 3. Challenges (and solutions) for digital REAs {.striped}

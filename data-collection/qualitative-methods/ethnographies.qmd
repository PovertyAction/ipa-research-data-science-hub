---
title: "Rapid Ethnographic Assessments guide"
format: html
...
:::{.subtitle-style}
Rapid Ethnographic Assessment (REA) is a complex method used in qualitative research. In this article, the IPA Colombia team provides guidance on how to plan and implement REAs as part of your IPA projects.
:::

:::{.authors-block}
**Authors:** [Dahian Dimaté](https://poverty-action.org/people/dahian-dimate), [Karen Moreno](https://poverty-action.org/people/karen-moreno-pinto), Maria Cecilia Dedios, [Nicól Lesmes](https://poverty-action.org/people/nicol-lesmes-guerrero), and [Nicolás Romero](https://poverty-action.org/people/nicolas-romero)


**Contributors:** [German Acosta](https://poverty-action.org/people/german-acosta), [Nicholas Guecha](https://poverty-action.org/people/nicholas-guecha), [Cristhian Pulido](https://poverty-action.org/people/cristhian-pulido), and [David Torres](https://poverty-action.org/people/david-francisco-torres-leon)
:::
---

## What are Rapid ethnographic Assessments?

Rapid Ethnographic Assessment (REA) is a qualitative research method that allows the agile collection of information for decision-making. This methodology is characterized by several key features[^1]:

#### Table 1: Key Features of Rapid Ethnographic Assessments
...
**With rapid ethnographies, information can be collected mainly through qualitative techniques**, such as interviews, focus groups, and observations. However, quantitative techniques, such as available data and short surveys, can also be used to support the answer to the research questions.[^3]
...
#### When is it useful to conduct a rapid ethnography?
...
If the answers to these questions align with your research needs, rapid ethnography may be an appropriate choice.

#### What kind of information is obtained?

The data produced during REA is gathered through a combination of various data collection techniques. The information and resources obtained from these techniques can be presented in a variety of formats. This interactive process involves the use of:
...
#### Additional considerations for conducting a rapid ethnography

**Common question:** How long does it take to conduct a rapid ethnography? 
- Although there is no set rule on how much time is sufficient to conduct it, most experts agree that the time spent in the field collecting data should be between **two and six weeks**.[^8] 
- The speed of data collection will depend on the research objectives, funding, and the technical expertise of the team. 

**Key considerations:**

- **When are the findings needed?**
- **Can the timeline be met?**
- **Are the necessary technical and financial resources available?**
...
### 3. Understanding the Desirable Skills of the Field Team

The quality of data produced during qualitative research activities is closely related to the skills of the moderator and facilitator. These competencies, outlined in **Table 3**, enable teams to recognize and adequately represent the diversity within qualitative data.
...
Currently, there are no standardized metrics to measure the prevalence of these skills among qualitative fieldwork moderators. Therefore, the skills in **Table 3** should be viewed as a resource for reference and reflection for teams.
...
#### Table 3: Desirable skills in the field team[^14]
...
- **Make a schedule defining the field collection activities:**
  - Define all field collection activities, the total number of tasks to be completed, and the time available.
  - Share the schedule with allies and key stakeholders to:
  ...
  - Use visual tools such as a Gantt chart for developing the schedule.

- **Verify the location and conditions of the places where the collection activities will take place:**
  - Identify safe locations that facilitate interaction with the community.
  - Work with local community organizations and leaders if possible.
  - Gather general field information and visit the community with someone locally trusted to establish rapport and familiarize yourself with the area.

- **Ensure the safety of the field team:**
  - Conduct a thorough risk assessment during the planning phase.
  - Prioritize the safety of both the field team and the community to minimize risks.

- **Ensure that you have all the necessary materials to carry out the activities:**
  - Prepare incentives for participants (if applicable).
  - Arrange refreshments, stationery, attendance lists, informed consents (if applicable), recording equipment, photographic equipment, batteries, etc.
...
In addition, the schedule of activities should include the time allocated by the team to:
...
- **Define a note-taking strategy for the different activities:** Note-taking is essential across all data collection activities in REA, even if recordings are available. The team leader should agree with the team on:
  - The format that everyone will use for their note-taking
...
## Conducting a rapid ethnographic assesment

### 1. How to start a REA?

1. **Establish periodic check-in meetings with the team.** 
...
2. **Guiding Questions for Check-Ins:**
...
### 2. Potential challenges during check-up meetings and fieldwork development

::: {.callout-tip}
## REA Setting and Community Integration
#### Engaging Migrant Communities
Researchers conducted rapid ethnographic assessments to understand the dynamics of migrant communities. The image below illustrates a typical REA setting where researchers engage with community members to gather insights.

![REA setting with migrant communities, photo by Nicol Lesmes](/assets/images/etpv-rea-setting.jpeg)
:::
...
## After a rapid ethnographic assesment
### 1. Perform data management and preparation
...
**First**, after each data collection journey, each team member must ensure secure data collection storage according to the protocols for developing human subject research defined for the project. Follow these steps:
...
#### Table 5. Considerations and challenges in digital ethnographies [^19]
...
[^1]: Adapted from: Palazzo L, Figueroa Gray M, Pullmann M, Lewis CC. (2023) Rapid Ethnographic Assessment: A toolkit for essential partner perspectives on short timelines. Pg. 2. 
...
[^3]: Palazzo L, Figueroa Gray M, Pullmann M, Lewis CC. (2023) Rapid Ethnographic Assessment: A toolkit for essential partner perspectives on short timelines. Pg. 22 and Sangaramoorthy, T., Kroeger, K. (2020). Rapid Ethnographic Assessments. A Practical Approach and Toolkit For Collaborative Community Research. Pg. 4.
[^4]: Ibid. pg. 2.
[^5]: Sangaramoorthy, T., Kroeger, K. (2020). Rapid Ethnographic Assessments. A Practical Approach and Toolkit For Collaborative Community Research. Pgs. 112-122.
[^6]: Lesmes Guerrero, N., Rojas, A. (2022) The role of leaders in the regularization process of Venezuelan migrants in Colombia. 
[^7]: Akhter S, Bashar F, Kamruzzaman M, et al. (2022). A Rapid Ethnographic Assessment of Cultural and Social Perceptions and Practices About COVID-19 in Bangladesh: What the Policy Makers and Program Planners Should Know. Qualitative Health Research.   
[^8]: Sangaramoorthy, T., Kroeger, K. (2020). Rapid Ethnographic Assessments. A Practical Approach and Toolkit For Collaborative Community Research. Pg. 24. 
[^9]: Vindrola-Padros, Cecilia. Rapid Ethnographies: A Practical Guide. Cambridge: Cambridge University Press, 2021. Pg. 66-69.
[^10]: Sangaramoorthy, T., Kroeger, K. (2020). Rapid Ethnographic Assessments. A Practical Approach and Toolkit For Collaborative Community Research. Pg. 66. 
[^11]: Palazzo L, Figueroa Gray M, Pullmann M, Lewis CC (2023) Rapid Ethnographic Assessment: A toolkit for essential partner perspectives on short timelines.
[^12]: Vindrola-Padros, Cecilia. Rapid Ethnographies: A Practical Guide. Cambridge: Cambridge University Press, 2021. Pg 14.
[^13]: Trotter, Robert T., Richard H. Needle, Eric Goosby, Christopher Bates, and Merrill Singer. 2001. A methodological model for rapid assessment, response and evaluation: The RARE program in public health. Field Methods 13(2): 137-159.
[^14]: Marío Luis Small and Jessica McCrory, Qualitative Literacy. A guide to evaluating ethnography and interview research (Oakland, 2022).
[^15]:   Vindrola-Padros, Cecilia. Rapid Ethnographies: A Practical Guide. Cambridge: Cambridge University Press, 2021. Pg. 66.
[^16]: Sangaramoorthy, T., Kroeger, K. (2020). Rapid Ethnographic Assessments. A Practical Approach and Toolkit For Collaborative Community Research. 
[^17]: Kozinets, Robert (2015).  Netnography. Seeking Understanding in a Networked Communication Society. DOI: 10.1002/9781118767771.wbiedcs067/
[^18]: Estella, Adolfo (2024). Digital Ethnography. A methodological monograph; QuestionPro (July 9, 2024). Digital ethnography: What it is, advantages and tools; Mosquera, Manuel Andrés (2008). From Anthropological Ethnography to Virtual Ethnography. Study of social relations mediated by the Internet. In: Fermentum. Revista Venezolana de Sociología y Antropología, vol. 18, no. 53, September-December, 2008, pp. 532-549.
[^19]: Adapted from: QuestionPro (July 9, 2024). Digital ethnography: What it is, advantages and tools.                                                                                                                                                                                                                                                                                    |

...
The quality of data produced during qualitative research activities is closely related to the skills of the moderator and facilitator.[^5] These competencies, outlined in @tbl-skills-field, enable teams to recognize and adequately represent the diversity within qualitative data.[^5] While these skills are typically developed through years of study and practice, field teams often consist of individuals from multidisciplinary backgrounds with varying levels of experience. Regardless of experience level, it is important to review and discuss these skills with your team to identify possible gaps and opportunities for improvement.
...
| Listen actively[^7] | Show full attention and interest. Consider both verbal and non-verbal communication. Ask thoughtful follow-up questions. | Demonstrates respect and engagement. Helps ensure accurate understanding. Allows deeper exploration of topics through appropriate follow-up. |
...
![Figure 1. Common mistakes made when conducting interviews](/assets/images/interviews-mistakes.png){width=100%}

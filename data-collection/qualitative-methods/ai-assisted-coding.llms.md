...
>
> Use anonymized or de-identified transcripts when running AI-assisted coding workflows. If you are unsure about your data classification, contact <support@poverty-action.org> or review the [IPA AI Usage Guidelines](https://ipastorage.box.com/s/mvr67ygvz1y3v8qmgjey67lk7msmyeks).
...
- Python 3.11 or later, with [uv](../../software/virtualenv/python-uv.llms.md) as the recommended environment manager
- An OpenAI API key, or an Anthropic API key as an alternative
- Basic familiarity with the command line and [Git](../../software/git/getting-started.llms.md)
- [VS Code](../../software/vscode/index.llms.md) or Positron as your code editor
...
- [Getting Started with Claude AI](../../software/claude/index.llms.md) covers setting up Claude Code for data analysts and project managers.

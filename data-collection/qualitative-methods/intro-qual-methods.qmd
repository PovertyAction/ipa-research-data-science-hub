...
:::{.page-subtitle}
Welcome to the world of qualitative research at Innovations for Poverty Action (IPA). Our mission to alleviate poverty requires more than just numbers—it demands a deep understanding of the human experiences, behaviors, and systems that drive change. Qualitative methods help us bridge the gap between data and the lived realities of the individuals and communities we aim to serve.
:::
...
::: {.grid}
::: {.g-col-6}
::: {.highlight-box style="background-color: rgb(255, 255, 255); padding: 10px; border-radius: 5px;"}
...
### Rapid Ethnographies
Rapid ethnographies are short-term, intensive studies that use ethnographic techniques to quickly gather in-depth information about a community or organization. This method is particularly useful for understanding cultural contexts and identifying key issues in a limited timeframe. [Learn more about Rapid Ethnographies](rapid-ethnographies.qmd)

### Interviews
Interviews involve one-on-one conversations between a researcher and a participant to explore individual experiences, beliefs, and motivations. This method allows for deep, personal insights and is flexible in terms of structure and depth. [Learn more about Interviews](interviews.qmd)

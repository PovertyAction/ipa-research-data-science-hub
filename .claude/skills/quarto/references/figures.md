...
Quarto provides comprehensive support for figures including sizing, layout,
subfigures, and accessibility features.
...
Alt text differs from caption - it describes the image content for
accessibility.
...
For arranging multiple figures, use layout divs. See [layout.md](layout.md) for
full layout options.

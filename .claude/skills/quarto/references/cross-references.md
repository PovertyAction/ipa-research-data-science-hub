...
Quarto provides a unified cross-reference system for figures, tables, equations,
sections, theorems, and more.
...
Both syntaxes work, but div syntax provides a more consistent pattern across all
element types (figures, tables, theorems, etc.).
...
[conversion-bookdown.md](conversion-bookdown.md).

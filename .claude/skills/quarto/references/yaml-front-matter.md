...
YAML front matter configures document metadata, format options, and execution
settings. It's located at the top of a document and is enclosed by `---`.
...
Built-in themes: `default`, `cerulean`, `cosmo`, `cyborg`, `darkly`, `flatly`,
...
See [engines.md](engines.md) for options, auto-detection rules, and

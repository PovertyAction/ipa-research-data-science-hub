...
Quarto provides column classes for controlling content width and placement,
including margin content.
...
Options: `body`, `body-outset`, `page`, `page-inset`, `screen`, `screen-inset`,
`margin`.

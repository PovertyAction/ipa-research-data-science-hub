...
Some of the documents require that you have Python, R, or Stata available on your computer.
...
See [Quarto guide](./software/quarto/index.qmd) for more details on how to use Quarto.
...
2. Set the page's `categories:` field to include its Diataxis type (`tutorial`, `how-to`, `reference`, or `explanation`). You may also add topical categories (e.g., `Data Quality`) for filtering; pages categorized `how-to` appear automatically in the [How-to Guides hub](how-to-guides.qmd).
...
This project uses markdownlint-cli to ensure consistent markdown formatting:

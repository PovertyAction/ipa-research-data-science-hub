...
2. Set the page's `categories:` field to its Diataxis type (`tutorial`, `how-to`, `reference`, or `explanation`). Pages categorized `how-to` appear automatically in the [How-to Guides hub](how-to-guides.qmd).

...
- **Register a pre-analysis plan** for the study on a trial registry such as the [AEA RCT Registry](https://www.socialscienceregistry.org/)
...
> **NOTE:**
>
> IPA maintains a data repository using Harvard’s Dataverse at [dataverse.harvard.edu/dataverse/IPA](https://dataverse.harvard.edu/dataverse/IPA). For step-by-step instructions on curating and uploading a replication package, see [How to Publish a Replication Package to Dataverse](../research-transparency/how-to-publish-dataverse.llms.md).

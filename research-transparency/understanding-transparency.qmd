...
Furthermore, when replications do occur but fail to reproduce the original findings, there's often no good venue for publishing these results. Journals may view them as "unoriginal" or "negative" findings. Simply posting replication results on websites is not ideal either, as they lack peer review and may not be discoverable by other researchers.
...
**Trial registration** involves publicly recording key information about a study before it begins. Registering a trial in the [American Economic Association's](https://www.socialscienceregistry.org/) Registry for Randomized Controlled Trials (AEA RCT Registry) or [ClinicalTrials.gov](https://clinicaltrials.gov/) creates a public record of the study's existence, combating publication bias.
...
- It's clear which outcomes were planned and which were explored post-hoc
...
Research transparency is not just a set of individual practices—it's an ecosystem involving multiple stakeholders working together to establish and maintain higher standards.
...
Journals like Proceedings of the National Academy of Sciences (PNAS) now require data to be deposited in a repository prior to publication, making openness a condition of publishing.

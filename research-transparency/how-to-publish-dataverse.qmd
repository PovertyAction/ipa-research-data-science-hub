...
For background on why data sharing matters, see [Understanding Research Transparency](understanding-transparency.qmd). For detailed requirements on what materials to include, see [Data Publication Preparation](publication-preparation.qmd).
...
For detailed information on identifying PII, including HIPAA guidelines, detection strategies, and anonymization techniques, see [Data Security Protocol: Personally Identifiable Information](../data-security/data-security-protocol.html#personally-identifiable-information-pii).
...
See [Data Publication Preparation](publication-preparation.qmd#readme-file-structure) for a complete ReadMe template.
...
3. Compress the folder by right-clicking and selecting "Send to" > "Compressed (zipped) folder"
4. Compress the resulting ZIP file a second time (double compression)
5. Remove the "(2)" from the final filename
...
![Folder Structure](../assets/images/dataverse/dataverse_new_dataset.png)
...
![Folder Structure](../assets/images/dataverse/dataverse_save_dataset.png)
...
![Folder Structure](../assets/images/dataverse/dataverse_edit_terms.png)
...
![Folder Structure](../assets/images/dataverse/dataverse_publish_dataset.png)

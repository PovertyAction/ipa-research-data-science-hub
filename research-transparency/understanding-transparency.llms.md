...
**Trial registration** involves publicly recording key information about a study before it begins. Registering a trial in the [American Economic Association’s Registry for Randomized Controlled Trials](https://www.socialscienceregistry.org/) (AEA RCT Registry) or [ClinicalTrials.gov](https://clinicaltrials.gov/) creates a public record of the study’s existence, combating publication bias.
...
> **NOTE:**
>
> IPA has created its own data repository using Harvard’s Dataverse platform. The repository makes data from IPA studies publicly accessible while ensuring proper documentation and ethical protection of participants. Visit [IPA’s Dataverse](https://dataverse.harvard.edu/dataverse/IPA) to explore available datasets.
...
The American Economic Association (AEA) provides a [Data and Code Availability Policy](https://www.aeaweb.org/journals/data/data-code-policy), which states:
...
Similarly, the American Political Science Association (APSA) requires authors of empirical papers to submit files for replication (see APSA [Data Policy](https://apsanet.org/publications/journals/ps-political-science-politics/faqs/data-policy/)).

The Quarterly Journal of Economics also provides a [Data Policy](https://academic.oup.com/qje/pages/data_policy).
...
A good reference for developing replication packages is provided by [Social Science Data Editors](https://social-science-data-editors.github.io/template_README/).
...
Organizations like [IPA](https://poverty-action.org/) and [J-PAL](https://www.povertyactionlab.org/) have made transparency a core part of their mission, demonstrating that high-quality research and transparent practices go hand in hand. By building transparency into organizational processes, these groups help normalize openness as standard practice rather than exceptional effort.

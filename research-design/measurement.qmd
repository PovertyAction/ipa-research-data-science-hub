...
Every survey question should meet these standards:

- **Specific**: Asks one question at a time
- **Measurable**: Quantifies accurate and unbiased information
- **Understandable**: Easy to comprehend and clearly defined
- **Relevant**: Measures a key or intermediate outcome
- **Framed**: Has clear boundaries (e.g., time frame, context)

...
- [IPA Randomization Guide with Example
  Do-files](https://ipastorage.box.com/s/sslf9h67yaejnhn3zz02ez3k508irzu8)
- [William Gould on Random Number
  Seeds](https://blog.stata.com/2016/03/10/how-to-generate-random-numbers-in-stata/)
- [StataCorp Blog Posts on Pseudo-Random Number
  Generators](https://blog.stata.com/tag/random-numbers/)

...
> | Method | Best for |
> |----|----|
> | [Focus group discussions (FGDs)](../data-collection/qualitative-methods/focus-groups.llms.md) | Shared norms, community perceptions, collective decision-making |
> | [In-depth interviews (IDIs)](../data-collection/qualitative-methods/interviews.llms.md) | Individual experiences, sensitive topics, sustained probing |
> | [Observations](../data-collection/qualitative-methods/observations.llms.md) | Behavioral outcomes, program implementation fidelity |
> | [Ethnographies](../data-collection/qualitative-methods/ethnographies.llms.md) | Deep contextual understanding over time |
>
> Common qualitative methods and their primary uses {.table-striped .caption-top .table}
>
...
>
> Qualitative contributions across the program scaling pathway {.table-striped .caption-top .table}
>
...
>
> Matching research questions to methodological approaches {.table-striped .caption-top .table}
>
...
>
> For a fuller treatment of this principle and how it applies to monitoring and evaluation system design, see the [Monitoring, Evaluation and Learning](../monitoring-evaluation-learning/ab-testing/index.llms.md) page.
>
> ## References
>

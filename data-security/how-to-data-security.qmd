...
This guide implements the standards outlined in the [Data Security Protocol](data-security-protocol.qmd). Review that document first to understand the principles behind these procedures.
...
**You'll need**: Pen and paper, password manager access
...
**Skill level**: Basic computer skills
**Required**: Laptop/desktop with admin access
...
**You'll need**: External drive or cloud storage access

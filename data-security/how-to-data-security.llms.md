...
> **NOTE:**
>
> This guide implements the standards outlined in the [Data Security Protocol](../data-security/data-security-protocol.llms.md). Review that document first to understand the principles behind these procedures.
>
> **Prerequisites:**
>
...
3.  **Install Desktop Application**:
    - Download from [cryptomator.org/downloads](https://cryptomator.org/downloads/)
...
- See [troubleshooting guide](../data-security/data-security-protocol.llms.md#encryption-protocols)
...
- **Main Reference**: [Data Security Protocol](../data-security/data-security-protocol.llms.md)
- **SurveyCTO Encryption**: [Official Documentation](https://docs.surveycto.com/02-designing-forms/02-additional-topics/06.encrypting.html)
...
- **CITI Training**: [Human Subjects Protection Training](https://about.citiprogram.org/)

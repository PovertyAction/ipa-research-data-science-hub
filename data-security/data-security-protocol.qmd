...
abstract: >-
  Reference guide outlining IPA's standards for data security, including
  handling of personally identifiable information (PII), device security,
  password protection, encryption, AI usage, and data backup practices. Includes
  a template for project-specific data security plans.

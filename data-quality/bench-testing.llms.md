...
A guide to systematically test surveys before data collection to identify and fix skip logic issues, unclear wording, and missing response options.
...
![](../assets/images/bench-test-1.png)
...
![](../assets/images/bench-test-2.png) ![](../assets/images/bench-test-3.png)
...
Abdul Latif Jameel Poverty Action Lab (J-PAL). “Questionnaire Piloting.” Accessed October 31, 2025. https://www.povertyactionlab.org/resource/questionnaire-piloting.

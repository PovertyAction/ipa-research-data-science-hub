...
:::{.custom-summary-block}
 This guide outlines the Data Quality Action Plan (DQAP), a tool designed to help IPA research staff systematically manage data quality throughout the data lifecycle. 
:::

![Data Quality Action Plan (® DeepAI)](/assets/images/mmd-dqap.jpeg){width=100%}

:::{.callout-tip appearance="simple"}
## Key Takeaways
* The DQAP provides a framework for planning, implementing, and acting on data quality checks, ensuring the effective use of the Data Management System (DMS 4.0) and other quality assurance measures.
...
If you are unable to access the file, please contact Research Support at [researchsupport@poverty-action.org](mailto:researchsupport@poverty-action.org).
